...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[4195];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/workspace/Receiver/Debug/configPkg/package/cfg/idle_p28L");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x1063;
